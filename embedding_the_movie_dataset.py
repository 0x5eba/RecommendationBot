...
ratings = pd.read_csv(path + 'final_ratings.csv')
del ratings['useless']
...
checkpoint = ModelCheckpoint('models/final_embedding_weights-{epoch:02d}-{val_acc:.2f}.hdf5' , monitor='val_loss' , verbose=1 , save_best_only=False)
